...
func init() {
	...
	// Maximum age of images to consider for deletion in days (default = 0)
	...
	// Maximum age of images to consider for deletion in years (default = 0)
	year = flag.Int("year", 0, "max age in years")
